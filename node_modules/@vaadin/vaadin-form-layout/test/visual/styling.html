...
<head>
  ...
  <script type="module" src="../../vaadin-form-layout.js"></script>
  <script type="module" src="../../vaadin-form-item.js"></script>
  <script type="module">
...
<body>
  ...
  <dom-module id="form-layout-bootstrap-styles" theme-for="vaadin-form-layout">
    <template>
      <style>
        :host {
  ...
  <dom-module id="form-item-bootstrap-styles" theme-for="vaadin-form-item">
    <template>
      <style>
        :host {
        ...
        :host(:not([label-position="top"])) [part~="label"] {
          text-align: right;
        }
      </style>
    </template>
