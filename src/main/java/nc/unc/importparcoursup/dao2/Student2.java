...
@Entity
@Table(name = Student2.TABLE_NAME)
public class Student2 {
    ...
    private Student2History studentHistory;
    ...
    public Student2History getStudentHistory() {
	return studentHistory;
    }

    public void setStudentHistory(Student2History studentHistory) {
